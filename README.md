...
> **[Try it online](https://huggingface.co/spaces/MusicHead17/citation-validator)** — no install required.  Paste a BibTeX bibliography or a reference list with DOIs and get results in minutes.
...
### Online (no install)
**[Try it here](https://huggingface.co/spaces/MusicHead17/citation-validator)** — two input modes:
...
Get results in your browser, no install required.
...
The 0% false-positive rate on 391 citations used no AI at all.
...
I don't pretend this tension is resolved — but I insist the
involvement be transparent, auditable, and reproducible.  Mine is.
...
test result in this project is freely available.  I believe that is
not incidental to the research — it is the research.

### Accessibility: where the tool stands

Until recently, using this tool required Python and a command line.
For a developer, that's trivial.  For a math teacher evaluating a
student's AI-assisted research, or a small-journal editor reviewing
submissions on a weekend, it was a wall.

The hosted version at
[huggingface.co/spaces/MusicHead17/citation-validator](https://huggingface.co/spaces/MusicHead17/citation-validator)
...
plugins, browser extensions, and inline journal-submission workflows.
Help on any of those would have outsized impact.
...
Wilson 95% CI: [0.0%, 0.96%].  I can claim <1% FPR with 95%
...
The AI makes the same epistemological error I fixed in the
...
- Same author wrote both the code and the tests
...
**M. Todd Edwards**, Department of Teaching, Curriculum, and Educational Inquiry, Miami University
*Editor, Ohio Journal of School Mathematics*
