...
|----|--------|-------|-------|----------|----------|-------|
| 6624 | Guerrero | Engage, Reflect, Improve: Enhancing Statistical Consulting Courses with AI Simulations | 24 | Mar 24 | Final author approval pending (requested Apr 5) | Lead article (page 1); coauthor corrections applied |
| 7188 | Imaninezhad | The Art of Problem Posing: From Bouncing Balls to Infinite Series | 12 | Mar 17 | Final proof confirmation pending | Version 2 confirmed by author; affiliation + acknowledgements integrated |
| 7236 | Moreno Cabeza | Thinking with Machines: Mediation, Joint Activity, and Embodiment in Mathematics Education through the Theory of Objectification | 16 | Mar 17 | Author response pending after proof resend | Proof re-sent Apr 5 with before/after paragraph comparison |
...
## Spring 2026 Issue (Volume 102, Number 2)

### ✅ Published
1. 6569 Aguilar - "Using an AI-Based Chatbot to Support the Learning of Algebraic Factoring" (English + Spanish)
2. 6616 Selmer - "Supporting Responsive Mathematics Teaching..."
3. 6647 Trivedi - "Math Isn't Neutral: Redesigning Word Problems..."
4. 6674 Moldavan - "From Prompt to Practice..."
5. 6902 Alhammouri - "Helping Students Hit the Target on Probability"
6. 6986 Koca - "AI as Collaborative Tool for Teachers..."
7. 7047 Imaninezhad - "An Elementary Difference-Matrix Evaluation..."
...
| Date | Submission | Action Required |
|------|------------|-----------------|
| Mar 27 | 6962 Morelo | Review expected back, send decision |
| Apr 4 | 6649 Druken | Author corrections due |
| Apr 7 | 6624 Guerrero | Author proof approval due |
| May 15 | Summer 2026 Issue | Target publication date |
| May 1 | 7158 Khadka | R&R deadline |
| May 15 | 6942 Lesser | R&R deadline (send decision) |
| Jun 30 | 6776 Mix | R&R deadline |

### Overdue
- **6932 Svoboda:** R&R was due Feb 15 - follow up needed

---

## Quick Stats
- **Summer 2026:** 3 typeset (prepublication), 2 in copyediting, 3 in review
...
## Update Log
- **4/5/26 (later):** 6624 Guerrero corrections applied (author order, affiliation/bio update, Appendix C.2 link inserted) and final all-author approval request sent.
- **4/5/26:** Updated Summer tracker after production progress: 7188 moved to prepublication (Version 2 + final edits integrated); 7236 moved to prepublication (proof re-sent with Historicity paragraph comparison); added May 15 Summer issue target.
