...
\begin{itemize}
  ...
  \item \citet{ghostcite2026}: 2.2 million citations from 56{,}381 papers in AI/ML and Security venues (2020--2025), with 1.07\% flagged as invalid.
  \item \citet{citeaudit2026}: 9{,}442 human-validated citations (6{,}475 real, 2{,}967 fake) spanning Google Scholar, OpenReview, arXiv, and BioRxiv.
\end{itemize}

\noindent My evaluation uses the Ansari dataset for real-world hallucinations and four additional synthetic categories (Section~3). Running the tool against the Rao \citep{rao2026} and CiteAudit \citep{citeaudit2026} benchmarks is identified as future work.
