...
We ran the identical experiment with Claude Sonnet 4 (Anthropic) as the AI provider, at a cost of approximately \$0.50 per 100 citations. We then ran both providers on a second dataset---the Frankenstein fakes (real authors paired with fabricated titles, no DOIs)---to test whether the Ansari results would replicate.
