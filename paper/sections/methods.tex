...
\begin{figure}[!h]
  ...
  \caption*{%
    ...
    An optional AI analysis toggle (bottom of interface) enables Tier~3 processing with a configurable provider. The tool is freely hosted at \url{https://tea-ai-math-citation-validator.hf.space}.
  }
\end{figure}
\FloatBarrier
