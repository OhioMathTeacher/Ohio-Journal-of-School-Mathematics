...
\begin{figure}[!h]
  ...
  \caption*{%
    ...
    An optional AI analysis toggle (bottom of interface) enables Tier~3 processing with a configurable provider. The tool is freely hosted at \url{https://musichead17-citation-validator.hf.space}.
  }
\end{figure}
\FloatBarrier
...
\begin{figure}[!h]
  ...
  \vspace{0.5\baselineskip}
  \fbox{\includegraphics[width=0.83\textwidth]{figures/fig3.png}}
  \vspace{0.75\baselineskip}
  \caption*{%
