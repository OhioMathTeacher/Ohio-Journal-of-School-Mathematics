...
\begin{figure}[!h]
  ...
  \caption*{%
    \textbf{Note:} Users paste a BibTeX bibliography or select a benchmark dataset, then click \emph{Validate Citations}. The tool is freely hosted at \url{https://musichead17-citation-validator.hf.space}.
  }
\end{figure}
\FloatBarrier
