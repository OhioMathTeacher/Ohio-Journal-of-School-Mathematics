...
\noindent\textit{*Indicates author who is currently a K--12 schoolteacher}
...
\subsection[\texorpdfstring{Math Isn't Neutral: Designing Word Problems with GPT-4 for Relevance }{Math Isn't Neutral: Designing Word Problems with GPT-4 for Relevance }]{Math Isn't Neutral: Designing Word Problems with GPT-4 for Relevance (\texorpdfstring{\url{https://doi.org/10.18061/ojsm.6647}}{})}

\begin{annotation}{Authors}
Mosum Trivedi* (2025). \textit{High school geometry/IB mathematics focus.}
\end{annotation}

\begin{annotation}{Summary}
Textbook word problems often miss students' lives; AI can address this when teachers maintain control of the design process. This practitioner-focused article demonstrates a practical, repeatable approach to using GPT-4 to design mathematically rigorous tasks that feel relevant to students. The author, a mathematics teacher at Detroit Public Schools, presents an iterative prompting approach that pairs content goals with Social Context and Pedagogical Approach parameters. Drawing on examples from a Detroit high school classroom, the paper shows how simple geometry items were reshaped into modeling tasks, civic case studies, and systems-based investigations. For immediate classroom use, the article includes: (1) a step-by-step implementation guide, (2) a revision checklist, and (3) a rubric for analyzing results. A classroom pilot using a trigonometry quiz with local contexts illustrates gains in student discourse, diagramming, and flexible reasoning. Particularly valuable for teachers seeking to make mathematics instruction more culturally relevant and contextually grounded while maintaining mathematical rigor.
\end{annotation}
...
\begin{annotation}{Authors}
Alesia Mickle Moldavan. \textit{Elementary teachers/K--12 classrooms focus. (Former secondary mathematics teacher)}
\end{annotation}
...
\begin{annotation}{Authors}
Megan E. Mocko, Lawrence M. Lesser, Alejandra Lugo*, Megan Shein (2025). \textit{Introductory business statistics focus.}
\end{annotation}
